...
#ifndef COMPARTMENTCONTAINER_H
#define COMPARTMENTCONTAINER_H
...
***********************/
class CompartmentContainer: public ContainerContent
{
public:
...
// [!] maybe I should make that class a kind of container property instead??
